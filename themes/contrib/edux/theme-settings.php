...
function edux_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['upgrade'] = [
    ...
    '#description'  => t('<h3>Upgrade To eduX Pro For $29 only.</h3>'),
    '#group' => 'edux',
  ];
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#description'   => t('edux theme has limitation of single image for slider. Separate image for each slide is available in eduxPro. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy eduxPro for $29 only.</a>'),
  ];
  ...
  $form['sidebar']['animated_sidebar'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy eduxPro for $29 only.</a>'),
    '#group' => 'sidebar_tab',
  ];
  ...
  $form['components']['social']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description'   => t('<h3>Share Page On Social networking websites</h3><p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/eduxpro" target="_blank">Buy eduxPro for $29 only.</a></p>'),
    '#group' => 'components_tab',
  ];
